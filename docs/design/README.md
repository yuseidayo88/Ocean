...
| 09 | [行き先の地図](./09-navigation.md) | どの画面のどれを押すと、どこへ飛ぶか。`?open=` で1件を名指しする |
| 10 | [動きの言葉](./10-motion.md) | 1つのイージング。何が動いて、何が動かないか |
| 11 | [図](./11-diagram.md) | archify の IR を OneFound に写す。図が成果物になる |
| 12 | [出す形](./12-outputs.md) | 成果物のフォーマット（報告 / 表データ / ページ / 図 …）と、持ち出し・PDF |
| 13 | [つないだ道具](./13-mcp.md) | MCP。AI社員が社長の道具をそのまま読む・書く |
| 14 | [会社が育つ](./14-learning.md) | AI社員の憲法と、学習の輪（手順書を書く・通す・畳む・思い出す・社長を覚える） |
